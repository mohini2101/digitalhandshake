...
import { faCreditCard, faBell, faSearch, faCameraAlt } from '@fortawesome/free-solid-svg-icons';
                ...
                <div className="containerteamnavbar">
                    ...
                    <div className="teamheaderprofile">
                        ...
                        <div className="teamprofiletext">
                            ...
                            <span className="profile-status1">Create and share your business card</span>
                        </div>
                    </div>
                </div>
            </div>
            <div className="teammiddle">
                <div className='search'>
                    ...
                    <button className='filter-icon'>
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M14 14.5C14 12.8431 15.3431 11.5 17 11.5C18.6568 11.5 20 12.8431 20 14.5C20 16.1569 18.6568 17.5 17 17.5C15.3431 17.5 14 16.1569 14 14.5Z" stroke="#413D7B" />
                            <path d="M3.99998 9.5C3.99998 11.1569 5.34312 12.5 6.99998 12.5C8.65683 12.5 9.99998 11.1569 9.99998 9.5C9.99998 7.84315 8.65683 6.5 6.99998 6.5C5.34312 6.5 3.99998 7.84315 3.99998 9.5Z" stroke="#413D7B" />
                            <path d="M16.9585 9L16.9585 2" stroke="#413D7B" stroke-linecap="round" />
                            <path d="M6.9585 15L6.9585 22" stroke="#413D7B" stroke-linecap="round" />
                            <path d="M16.9585 22L16.9585 20" stroke="#413D7B" stroke-linecap="round" />
                            <path d="M6.9585 2L6.9585 4" stroke="#413D7B" stroke-linecap="round" />
                        </svg>

                    </button>
                </div>

                <div className='teammiddle2'>
                    <div>
                        <img className='visitingCard' src={require('../DetailedTeam/visiting card.gif')} alt="Team" />
                    </div>
                    <div className='teamText'>
                        <h2>No Team Added Yet</h2>
                        <h6>Open the camera and start adding business </h6>
                        <h6>card to your library!</h6>
                    </div>
                </div>
