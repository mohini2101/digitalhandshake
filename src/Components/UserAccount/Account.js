...
import Success from '../SuccessFulLogin/SuccessPopup';
import { FontAwesomeIcon } from '@fortawesome/react-fontawesome';
import { faCreditCard, faBell, faEdit } from '@fortawesome/free-solid-svg-icons';
...
const Account = () => {
    ...
    return (
        <div className={isFrameVisible || isSuccessVisible ? 'light-black-background' : ''}>
            {!isSuccessVisible && (
                <div>
            ...
            {!isSuccessVisible && (
                <div className="containeraccount">
                    <div className="containernavbar">
                        <div className="containervector1">
                    ...
                    <div className="middle">
                        <div className="middle1">
                            <p className="middle1profile">Profile <FontAwesomeIcon icon={faEdit} className="edit-icon" ></FontAwesomeIcon></p>
                            <div className="input-container">
                                {/* <p>Email <input type="text" className="input-field-email" placeholder='admin@gmail.com'/> </p> */}
                                {/* <p>Password <input type="password" className="input-field-pass" placeholder='******'/></p> */}
                                <p>Email <span className='input-field-email' contentEditable="true">admin@gmail.com</span></p>
                                <p>Password <span className='input-field-pass' contentEditable="true">******</span></p>
                                <p className="change-pass" onClick={openFrame}>Change Password</p>
                                {isFrameVisible && <Frame onClose={closeFrame} onSuccess={openSuccess} />}
                            </div>
                        </div>

                        <div className="middle2">
                            <p className="exports">Exports</p>
                        ...
                        <div className="middle3">
                            <p className="CS">Contact Support</p>
                        </div>
            ...
            {isFrameVisible && !isSuccessVisible && (
                <div className="modal-overlay">
                    <div className="modal-content">
                        <Frame onClose={closeFrame} onSuccess={openSuccess} />
                    </div>
                </div>
            )}
        </div>
