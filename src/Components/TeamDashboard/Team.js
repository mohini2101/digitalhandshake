...
import CreateTeam from '../TeamCreatePopUp/CreateTeam';
...
const Team = () => {
    ...
    return (
        <div className={isFormVisible ? 'light-black-background' : ''}>
            <div>
            ...
            <div className="containerteam">
                <div className="containerteamnavbar">
                    ...
                    <div className="teamheaderprofile">
                        ...
                        <div className="teamdashboard_teamprofiletext">
            ...
            <div className="teammiddle">
                <div className='teamsearch'>
                    ...
                    />
                    <FontAwesomeIcon icon={faSearch} className="teamdashboard_search-icon" />
                </div>

                <div className='teammiddle2'>
                    <div>
                        <img className='teamimage' src={require('../TeamDashboard/teamimage.gif')} alt="Team" />
                    </div>
                    <div className='teamText'>
                        <h2>No Team Added Yet</h2>
                        <h6>click on add button to add new team</h6>
                        <button onClick={openCreateTeam}>Add Team</button>
                        {isFormVisible && (
                            <div className="modal-overlay">
                                <div className="modal-content">
                                    <CreateTeam onClose={closeCreateTeam} />
                                </div>
                            </div>
                        )}
                    </div>
